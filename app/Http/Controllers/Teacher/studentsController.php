...
class studentsController extends Controller
{
    ...
    {    	
    	...
    	$students = Student::join("users","students.id","=","users.id")
					...
					->join("course_types","course_types.course_id","=","order_products.course_id")
					->join("coursetype_variations","coursetype_variations.coursetype_id","=","course_types.id")
					->where('coursetype_variations.teacher_id', '=', $teacher->id);
        ...
        return view('teachers.students._search_results',	array(
        			'students'=>$students			
		)); 
	...
	public function postCreate(Request $request){		
       ...
       return redirect("teachers/students/create");
   } 
   ...
   public function getEdit($id){
	    ...
	    return view("teachers.students.edit",array(
    		"users"=>$users,"monthsArr"=>$monthsArr,
   ...
   public function postEdit(Request $request,$id){
       $student_id = $id;
		...
		return redirect("teachers/students/edit/".$student_id);
   }
   ...
   public function getUserDetails(Request $request){
	...
	$user = User::findOrFail($user_id);
	return view("teachers.students.tabs._user_details",array("user"=>$user));
   }
