...
class studentsexamsController extends Controller
{
    ...
    public function editstudycase($id)
    {
        $study_case=StudentStudyCase::findOrFail($id);    
            return  view('admin.students-stage-studycase.study_case.edit',array('study_case'=>$study_case,'table_name'=>$this->table_name,'record_name'=>$this->record_name)); 
    }
     ...
     $stages=StudentStage::paginate(10) ;
       ...
       $_stageshow=true;
        ...
        return view('admin.students-stage-studycase.index', array(
            ...
            "table_name" => "students-Stage-StudyCase", "record_name" => $this->record_name,"stageshow"=>$_stageshow
        ));
    }
        ...
        public function indexStudycase(Request $request)
    {
        ...
        $courses = Course::get();
        return view('admin.students-stage-studycase.study_case.index', array(
            "students" => $students, "courses" => $courses,'study_cases'=>$study_cases,
            "table_name" => "students-StudyCase", "record_name" => $this->record_name
        ));
    }
    /**
