$(document).ready(function() {
        ...
        // Range 1
        $( function() { $( "#slider-range_one" ).slider({RTL: true, range: true, min: 0, max: 500, values: [ 75, 300 ], slide: function( event, ui ) { $( "#amount_one" ).val(+ ui.values[ 0 ] ); $( "#amount_two" ).val(+ ui.values[ 1 ] ); } }); $( "#amount_one" ).val($( "#slider-range_one" ).slider( "values", 0 )  ); $( "#amount_two" ).val($( "#slider-range_one" ).slider( "values", 1 ) ); } );
