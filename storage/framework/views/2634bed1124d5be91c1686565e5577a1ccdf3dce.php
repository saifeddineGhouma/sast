...
console.log(course_id) ;
   ...
   $.ajax({
    ...
    $(".select_form").change(function(){
       ...
       var vat = '<?php echo e(App('setting')->vat); ?>';
    ...
    function country_select(e){
        ...
        if(countryId!=""){
            ...
            $.ajax({
                url: "<?php echo e(url('/home/governments')); ?>",
                data: {countryId: countryId},
                type: "get",
                beforeSend: function(){
                    country.closest(".controls").append("<img src='<?php echo e(asset('assets/admin/img/input-spinner.gif')); ?>' width='20' />");
                },
