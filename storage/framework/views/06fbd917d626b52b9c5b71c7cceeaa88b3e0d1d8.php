                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <?php if(!empty($first_Variation->government)): ?>
                                        <p><?php echo e(isset($first_Variation->government->government_trans(App("lang"))->name) ? $first_Variation->government->government_trans(App("lang"))->name : $first_Variation->government->government_trans("en")->name); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php else: ?>
