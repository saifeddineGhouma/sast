        ...
        <div class="col-lg-12">
            <div class="panel panel-primary filterable portlet box">
                ...
                <div class="panel-body">
                    ...
                    <form id="form1" action="{{ url('teachers/'.$table_name.'/'.$studentQuiz->id) }}" method="POST" class="form-horizontal form-row-seperated" novalidate>
                        {{ csrf_field() }}
                        ...
                        <!--div class="form-actions left" style="float: right;">
                            ...
                            <button type="button" class="btn btn-secondary-outline" onclick="js:window.location='{{url('/teachers/students-exams')}}'"><i class="fa fa-reply"></i> Cancel</button>
                        </div-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="panel">
                                                ...
                                                <div class="panel-body">
                                                    @include("teachers.".$table_name.".tabs._quiz")
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="tab_2">
                                    <div class="row">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                @include("teachers.".$table_name.".tabs._answers")
                                            </div>
                                        </div>
                                    </div>
                                </div>
