	...
	<div class="col-md-2">
		...
		<div class="form-group">
			<label class="radio-inline">
				<input type="radio" name="image_width" value="{{ $certificate->image_width or 3508 }}" checked="checked">Vertical
			</label>
			<label class="radio-inline">
				<input type="radio" name="image_width" value="{{ $certificate->image_width or 4961  }}">Horizontal
			</label>
		</div>
			...
			<div class="panel panel-default">
				...
				<div id="collapse4" class="panel-collapse collapse">
					<div class="panel-body" style="padding: 10px;">
						...
						<div class="form-group col-sm-12">
							<label>Text:</label>
							<input type="text" class="form-control" id="date" name="date" value="<?php echo date("Y-m-d"); ?>" onfocusout="drawTextTFromInput()">
						</div>
