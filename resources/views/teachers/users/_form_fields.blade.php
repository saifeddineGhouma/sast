    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select type="text" name="country_id" required class="form-control country_id">
                        <option value="">choose...</option>
                        @foreach($countries as $country)
                            <option value="{{$country->id}}" {{($method=="edit" &&!empty($user->government)
                    			&& $user->government->country_id == $country->id)?'selected':null}}>
                                {{$country->country_trans(App("lang"))->name or $country->country_trans("en")->name}}
                            </option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select type="text" name="government_id" required id="government_id"  class="form-control government_id">
                        <option value="">choose...</option>
                        @if($method=="edit" && !empty($governments))
                            @foreach($governments as $government)
                                <option value="{{$government->id}}" {{($user->government_id == $government->id)?'selected':null}}>
                                    {{$government->government_trans(App("lang"))->name or $government->government_trans("en")->name}}
                                </option>
                            @endforeach
                        @endif
                    </select>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class="control-label col-md-3">clothing size</label>
            <div class="col-md-9">
  ...
  <div class="row">
  	...
  	<div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" required name="nationality" value="{{($method=='edit')?$user->nationality:null}}">
            </div>
        </div>
  	</div>
  </div>
...
<div class="row">
  ...
  <div class="form-group {{$method=='add'?'display-none':''}}" >
  	<div class="col-md-4 col-md-offset-3">
  		<input type="checkbox" required id="checkPassword" name="checkPassword" >change password
  	</div>
  </div>
