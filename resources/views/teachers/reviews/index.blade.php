                          		 ...
                          		 <div class="form-group">
                                    ...
                                    <select name="course_id" class="form-control select2" >
                                   		...
                                   		@foreach($courses as $course)
                                   			<option value="{{$course->id}}">{{$course->course_trans(App("lang"))->name}}</option>
                                   		@endforeach
                                    </select>
                                </div>
                          	</div>                        	
...
@include('teachers.reviews.js.index_js')
