...
<section class="content-header">
    <!--section starts-->
    <h1>edit Forum {{$courseQuestion->id}}</h1>
    <ol class="breadcrumb">
        <li>
            <a href="{{url('/teachers')}}">
        ...
        <li>
            <a href="{{url('/teachers/forum')}}">Forums</a>
        </li>       
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary filterable portlet box">
                ...
                <div class="panel-body">
	                ...
	                @include("teachers.forum._form",array("method"=>"edit"))
                </div>
           </div>
	    </div>
	</div>
...
<script  src="{{asset('assets/admin/vendors/ckeditor/config.js')}}" type="text/javascript"></script>
	...
	@include("teachers.forum.js.form_js")
@endsection
