        ...
        <div class="col-lg-12">
            <div class="panel panel-primary filterable portlet box">
                ...
                <div class="panel-body">
                    ...
                    <form id="form1" action="{{route('students.studycase.update',$study_case->id)}}" method="POST" class="form-horizontal form-row-seperated" novalidate>
                        {{ csrf_field() }}
                        ...
                        <div class="panel">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input  type="text"  name="student_name" class="form-control" value="{{ $study_case->student->user->full_name_ar }}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Student UserName</label>
                                <div class="col-md-10">
                                    <input  type="text"  name="student_username" class="form-control" value="{{ $study_case->student->user->username }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input  type="text"  name="course_name" class="form-control" value="{{ $study_case->course->course_trans("ar")->name or  $study_case->course_name}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea cols="60"  name="manager_message"  class="form-control">{{$study_case->manager_message}} </textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">website message</label>
                                <div class="col-md-10">
                                    <textarea cols="60"  name="website_message"  class="form-control">{{$study_case->website_message}} </textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">user message</label>
                                <div class="col-md-10">
                                    <textarea cols="60"  name="user_message"  class="form-control">{{$study_case->user_message}} </textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="radio-list">
                                        <label>
                                            <input type="radio" name="successful" value="1"  {{($study_case->successful)?"checked":null}}/>
                                            Successfull  </label>
                                        <label>
                                            <input type="radio" name="successful" value="0" {{(!$study_case->successful)?"checked":null}} />
                                            Failed </label>
                                    </div>
                                </div>
                            </div>
