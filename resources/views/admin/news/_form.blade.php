...
<?php
	...
	?>
<form method="POST" id="news-form" action="{{$url}}" class="form-horizontal form-bordered form-label-stripped">
    <div class="form-body">
		<input type="hidden" name="methodForm" id="methodForm" value="{{$method}}"/>
		<input type="hidden" id="id" name="id" value="{{$method=='edit' ? $news->id:'0'}}">
        {{csrf_field()}}
		...
		<div class="form-actions left" style="float: right;">
	        ...
	        <button type="button" class="btn btn-responsive btn-default" onclick="js:window.location='{{url('/admin/news')}}'"><i class="fa fa-reply"></i> Cancel</button>
	    </div>	
		    ...
		    <div id="tab1" class="tab-pane fade active in">										
	            ...
	            <div class="col-lg-12">
	                <div class="panel">
	                    ...
	                    @include("admin.news.tabs._general")
					</div>
				</div>					
				</div>
			</div>
