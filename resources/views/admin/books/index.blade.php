	                        ...
	                        <tbody>
		                        @foreach($books as $key=>$item)
		                            <tr>
		                                <td>{{$item->id}}</td>
		                                <td>
											{{$item->book_trans("ar")->name}}
		                                </td>
		                                <td>
		                                 	{{$item->book_trans("ar")->slug}}
		                                </td>
		                                <td>
		                                	{{$item->price}}
		                                </td>
		                                ...
		                                <td>
		                                	<a href="{{ action('Admin\booksController@edit', $item->id) }}">
	                                        ...
	                                        <a data-toggle="modal" class="deleterecord" elementId="{{$item->id}}">
	                                            <i class="livicon" data-name="remove-circle" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete book"></i>
	                                        </a>
		                                </td>
