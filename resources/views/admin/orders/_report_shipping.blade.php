<img src="{{asset('uploads/kcfinder/upload/image/orders/orders'.$order->id.'.jpg')}}" width="100%" />
...
<!--div class="col-xs-12">
	<table class="table table-bordered">
		@include("admin.orders._products",array("method"=>"view"))
	</table>
</div>
						...
						<tr>
							...
							<td>
								...
								@if($order_onlinepay->payment_method=="banktransfer")
									<br/>
									<img src='{{asset("uploads/kcfinder/upload/image/bank_transfers/".$order_onlinepay->banktransfer_image)}}' style="max-width:100px;" alt="no image"/>
								@endif
							</td>
							<td>
