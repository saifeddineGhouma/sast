...
$('.deletsubscriber').on('click', deleteRecord);
	function deleteRecord(e) {
		...
		bootbox.confirm({
			...
			message: "Are you sure to delete this subscriber? This operation is irreversible.",
		    callback: function(result) {
				if (result == true) {
		            $.ajax({
		                url: "{{url('admin/newsletter/deletesubscriber/')}}" + '/' + id,
		                type: 'POST',
		                headers: {
