	                    ...
	                    <table class="table table-striped table-bordered" id="table1">
	                        ...
	                        <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                	@if(!empty($u->user))
	                                		<a href="{{url('/admin/user/view/'.$u->user->id)}}">{{$u->user->username}}</a>
	                                	@else
	                                		unregistered
	                                	@endif
	                                </td>
	                                <td>
	                                	...
	                                	@else
	                                		<span class="label label-sm label-danger"> not activated </span>
	                                	@endif
	                                </td>
	                                <td>
	                                ...
	                                <td>
                                        <a data-toggle="modal" class="deletsubscriber" elementId="{{$u->id}}">
                                            <i class="livicon" data-name="remove-circle" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete subscriber"></i>
                                        </a>
	                                </td>
	                            </tr>
	                            @endforeach
...
@include('admin.newsletter.js.subscriber_js')
@endsection
