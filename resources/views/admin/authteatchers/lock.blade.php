    ...
    <div class="container">
        <div class="login-container">
            ...
            <div class="form-box">
                ...
                <form method="POST" id="lock-form" name="screen" action="{{url('admin/home/lock')}}">
                	{{csrf_field()}}
                    <div class="form">
                        <p class="form-control-static">{{Auth::guard("admins")->user()->name}}</p>
                        <input type="password" name="password" class="form-control" placeholder="Password">
                         
	                    <a class="notadmin" href="{{url('admin/home/logout1')}}">لست {{Auth::guard("admins")->user()->name}} ؟</a>
