  <?php
	...
	if($method == 'add'){
		$url = url('admin/forum/create/');
		$btn=trans('admin.add');
	}else {
		$url = url('admin/forum/edit/'.$courseQuestion->id);
		$btn="edit";
	}
 ...
 <div class="portlet-body">
	...
	<form action="{{$url}}" method="post" id="forum-form" class="form-horizontal form-row-seperated">
		...
		<div class="form-group">
			...
			<div class="col-md-10">
				<input  type="text" value="{{$method=='edit'?$courseQuestion->user->username:''}}" class="form-control" readonly>
			</div>
		</div>
		...
		<div class="form-actions" >
			<div class="row">
				<div class="col-md-offset-3 col-md-9">
					...
					<button type="button" class="btn btn-secondary-outline" onclick="js:window.location='{{url('/admin/forum')}}'"><i class="fa fa-reply"></i> الغاء</button>
				</div>
			</div>
		</div>
