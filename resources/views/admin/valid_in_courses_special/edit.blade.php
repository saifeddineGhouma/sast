        ...
        <div class="col-lg-12">
            <div class="panel panel-primary filterable portlet box">
                ...
                <div class="panel-body">
                    ...
                    <form id="form1" action="{{route('courses_special.update',$courses_special->id)}}" method="POST" class="form-horizontal form-row-seperated" novalidate>
                        {{ csrf_field() }}
                        ...
                        <div class="panel">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input  type="text"  name="student_name" class="form-control" value="{{ $courses_special->student->user->full_name_ar }}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Student UserName</label>
                                <div class="col-md-10">
                                    <input  type="text"  name="student_username" class="form-control" value="{{ $courses_special->student->user->username }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input  type="text"  name="course_name" class="form-control" value="{{ $courses_special->course->course_trans("ar")->name }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="form-control">
                                         ...
                                         <option value="success"{{ $courses_special->status == "success" ? 'selected' : '' }}>Success</option>
                                         <option value="waiting" {{ $courses_special->status == "waiting" ? 'selected' : '' }}>Waiting</option>
                                          <option value="failed" {{ $courses_special->status == "failed" ? 'selected' : '' }}>Failed</option>
