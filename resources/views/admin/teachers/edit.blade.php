...
<section class="content-header">
    <!--section starts-->
    <h1>Edit Teacher {{$teacher->teacher_trans("ar")->name}}</h1>
    <ol class="breadcrumb">
        <li>
            <a href="{{url('/admin')}}">
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary filterable portlet box">
            	 <div class="panel-heading clearfix">
	                    <div class="panel-title pull-left">
                           <div class="caption">
		                        ...
		                        Edit Teacher {{$teacher->teacher_trans("ar")->name}}
		                    </div>
	                    </div>
	                </div>
                ...
                <div class="panel-body">
	                ...
	                @include("admin.teachers._form",array("method"=>"edit"))
                </div>
           </div>
	    </div>
	</div>
...
<script src="{{asset('assets/admin/vendors/bootstrap-maxlength/bootstrap-maxlength.min.js')}}" type="text/javascript"></script>
    ...
    @include("admin.teachers.js.form_js")
    <script>
