...
<section class="content-header">
    <!--section starts-->
    <h1>Edit {{ $record_name }} {{$quiz_trans_ar->name}}</h1>
    <ol class="breadcrumb">
        <li>
            <a href="{{url('/admin')}}">
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary filterable portlet box">
            	 <div class="panel-heading clearfix">
	                    <div class="panel-title pull-left">
                           <div class="caption">
                                ...
                                Edit {{ $record_name }} {{$quiz_trans_ar->name}}
		                    </div>
	                    </div>
	                </div>
                ...
                <div class="panel-body">
                    ...
                    <form id="form1" action="{{ url('admin/'.$table_name.'/'.$quiz->id) }}" method="POST" class="form-horizontal form-row-seperated" novalidate>
                        {{ csrf_field() }}
