                ...
                <div class="panel-body">
	                ...
	                <div id="reloaddiv">
	                    <table class="table table-striped table-bordered" id="table1">
	                        ...
	                        <tbody>
		                        @foreach($videoexams as $key=>$item)
		                            <tr>
		                                <td>{{$item->id}}</td>
		                                <td>
											{{$item->videoexam_trans("ar")->name}}
		                                </td>
		                                <td>
		                                 	{{$item->videoexam_trans("ar")->slug}}
		                                </td>
		                                <td>
		                                ...
		                                <td>
		                                	<a href="{{ action('Admin\videoexamsController@edit', $item->id) }}">
	                                            <i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="edit video exam"></i>
	                                        </a>
	                                        <a data-toggle="modal" class="deleterecord" elementId="{{$item->id}}">
	                                            <i class="livicon" data-name="remove-circle" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete video exam"></i>
	                                        </a>
		                                </td>
