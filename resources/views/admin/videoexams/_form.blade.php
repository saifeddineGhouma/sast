		...
		<input type="hidden" id="id" name="id" value="{{$method=='edit' ? $videoExam->id:"0"}}">
            ...
            <ul class="nav nav-tabs">
				...
				<li>
					<a href="#tab_courses" data-toggle="tab"> courses
						<span class="badge badge-success"> {{$videoExam->courses_exams->count()}} </span>
					</a>
				</li>
            </ul>
				...
				<div class="tab-pane" id="tab_courses">
					<div class="row">
						<div class="panel">
							...
							<div class="panel-body">
								@include("admin.".$table_name.".tabs._courses",["exam"=>$videoExam])
							</div>
						</div>
					</div>
				</div>
