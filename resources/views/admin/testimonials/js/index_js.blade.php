...
$('.deletetestimonial').on('click', deleteRecord);
	function deleteRecord(e) {
		...
		bootbox.confirm({
			...
			message: "Are you sure to delete this testimonial? This operation is irreversible.",
...
function swap(state,field,this1){
	...
	$.ajax({
		url: '{{ url("/admin/testimonials/updatestateajax") }}',					
		type:  'POST',
