...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Book Orders</li>
    </ol>
</section>
<!--section ends-->
                ...
                <div class="panel-body">
	                ...
	                <div class="well table-toolbar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                          		 <div class="form-group">
                                    <label class="control-label bold">book</label>
                                    <select name="book_id" class="form-control">
                                   		<option value="0">choose...</option>
                                   		@foreach($books as $book)
                                   			<option value="{{$book->id}}">{{$book->book_trans("ar")->name}}</option>
                                   		@endforeach
                                    </select>
                                </div>
                          	</div>
...
@include('admin.bookorders.js.index_js')
