        ...
        <div class="col-lg-12">
            <div class="panel panel-primary filterable portlet box">
                ...
                <div class="panel-body">
                    ...
                    <form id="form_cat" action="{{ url('admin/seo/edit/'.$seo->id) }}" method="POST" class="form-horizontal form-row-seperated" novalidate>
                        {{ csrf_field() }}
                        <input type="hidden" name="_method" value="PATCH">

                        @include('admin.seo._form',array("method"=>"edit"))
