	...
	<div class="container">
		<div class="col-md-12">
			<div class="col-md-12" align="right"> 
				<br>
				<a href="{{route('convertToPDF',[$order->id,$user->id])}}" class="btn btn-info"> print </a>
									...
									<td rowspan="{{$orderproduct->num_students}}">
										<?php
											...
											elseif(!empty($orderproduct->book_id)&&!empty($orderproduct->book)){
												...
												$pack = $orderproduct->pack->titre;
												if(!empty($pack)){
													$product_details = $pack;
													$url = url(App('urlLang').'packs/'.$orderproduct->pack_id);
												}
											}
