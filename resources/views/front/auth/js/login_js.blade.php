<script>
	...
	function commonValidateForm(formid){	
		...
		jQuery(formid).find("input.required,textarea.required,select.required").each(function(){	
	        ...
	        if(jQuery(this).val() == ""){        	
				...
				jQuery(this).closest('.form-group').append('<span class="help-block">{{trans("home.this_field_required")}}</span>');
	...
	function validate_input(input){
		...
		if(input.val() == ""){
			...
			input.closest('.form-group').append('<span class="help-block">{{trans("home.this_field_required")}}</span>');
