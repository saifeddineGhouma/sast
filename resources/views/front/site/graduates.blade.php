                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            <span>@lang('navbar.gratuated')</span>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="container padding-50">
        ...
        <form  id="info_form" method="get" action="{{ url(App('urlLang').'graduates') }}" enctype="multipart/form-data" autocomplete="on" >
            ...
            <div class="col-xs-12 userlogedin text-right">
                ...
                <div class="col-md-8">
                    <div class="form-group autocomplete"  >
                        <input type="text" placeholder="@lang('navbar.searchByNameOrCertificat')" class="form-control search-name"  id="myInput" style="direction: {{ $dir }}" name="code"/>
                    </div>
                </div>
        ...
        <table class="table" dir={{$dir}}>
            ...
            <tr role="row">
              <!--   <th width="10%">#</th> -->
            <th style="text-align: {{ $textalign }}"> @lang('navbar.year') </th>
            </tr>
            </thead>
            <tbody>
                <?php $j=1;?>
                @for($i=$currentYear;$i>=2015;$i--)
                    <tr>
                        <!-- <td>{{ $j }} </td> -->
                        <td> <a href="{{ url(App('urlLang').'graduates?year='.$i) }}">{{$i}}</a> </td>
                    </tr>
                    <?php $j++;?>
                @endfor
            </tbody>
